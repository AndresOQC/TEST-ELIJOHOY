...
async function finalizarTestAutomaticamente() {
  ...
  // Verificar que hay al menos 70 respuestas (el test tiene 70 preguntas)
  if (cantidadRespuestas < 70) {
    throw new Error(`Test incompleto: ${cantidadRespuestas}/70 respuestas`)
  }
